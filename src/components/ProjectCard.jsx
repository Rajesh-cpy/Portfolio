        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 bg-black/75 backdrop-blur-md">
            ...
            >
              ...
              {/* Scrollable inner wrapper — flex-1 + min-h-0 forces this to take
                  the remaining height inside the flex column and become the
                  real scroll container, instead of expanding past the modal
                  and getting clipped by overflow-hidden on the parent */}
